...
export default function AppJurnalKegiatan() {
  const { setActivePortal } = useAdminLayout();

  useEffect(() => {
    setActivePortal('kegiatan');
  }, [setActivePortal]);
  ...
  return (
    <div className="w-full">
      ...
      {/* Main Grid Content */}
      <div className="max-w-7xl w-full mx-auto px-6 mt-8 print:mt-0 space-y-6 flex-1">
        
        {/* Title */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-left print:hidden">
          <div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-4 shadow-sm">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-left">
            ...
            <div className="flex flex-wrap gap-2.5 ml-auto print:hidden">
              <button
                onClick={exportToCSV}
              ...
              <button
                ...
                className="px-3 py-2 bg-[#561C24] hover:bg-[#6D2932] text-white text-xs font-bold rounded-lg transition-all flex items-center gap-1.5 cursor-pointer active:scale-95 shadow-sm"
                title="Cetak rekapitulasi data format PDF"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 pt-2 print:hidden">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto animate-fadeIn print:hidden">
      ...
      {isZoomModalOpen && (
        <div 
          className="fixed inset-0 z-[120] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 cursor-zoom-out print:hidden"
      ...
      {notification && (
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-md z-[100] flex items-center justify-center p-4 select-none animate-fadeIn print:hidden">
